@echo off
:: Enhanced Batch Script for Installing NLTK Version 3.9.1
...
:: Install NLTK version 3.9.1
echo Installing NLTK version 3.9.1...
pip install nltk==3.9.1

:: Check if the installation was successful
if %ERRORLEVEL% EQU 0 (
    echo NLTK version 3.9.1 installed successfully!
) else (
